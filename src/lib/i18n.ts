...
export const LANDING: Record<Locale, LandingT> = {
  ...
  en: {
    ...
    feat2Title: "Automatic social media posting", feat2Desc: "One click sends your content to Facebook, Instagram, TikTok and LinkedIn. SOME Video Post schedules and SOME Video Post posts automatically at your chosen times.",
    ...
    test1Name: "Mette K.", test1Role: "Airbnb host, Skagen", test1Quote: "I save at least 5 hours a week. SOME Video Post SOME Video Post posts automatically while I focus on my guests. The videos are impressively professional!",
  ...
  es: {
    ...
    feat2Title: "Publicación automática en redes sociales", feat2Desc: "Un clic envía tu contenido a Facebook, Instagram, TikTok y LinkedIn. SOME Video Post programa y SOME Video Post publica automáticamente en los horarios que elijas.",
    ...
    test1Name: "Mette K.", test1Role: "Anfitriona Airbnb, Skagen", test1Quote: "Ahorro al menos 5 horas a la semana. SOME Video Post SOME Video Post publica automáticamente mientras me centro en mis huéspedes. ¡Los vídeos son impresionantemente profesionales!",
  ...
  de: {
    ...
    feat2Title: "Automatische Social-Media-Beiträge", feat2Desc: "Ein Klick sendet deine Inhalte an Facebook, Instagram, TikTok und LinkedIn. SOME Video Post plant und SOME Video Post postet automatisch zu deinen gewählten Zeiten.",
    ...
    test1Name: "Mette K.", test1Role: "Airbnb-Gastgeberin, Skagen", test1Quote: "Ich spare mindestens 5 Stunden pro Woche. SOME Video Post SOME Video Post postet automatisch, während ich mich auf meine Gäste konzentriere. Die Videos sind beeindruckend professionell!",
