...
export const LANDING: Record<Locale, LandingT> = {
  da: {
    ...
    step2Title: "AI skaber din video", step2Desc: "AI'en sammensætter en smooth præsentationsvideo med cinematiske overgange og stemningsfuld musik.",
  ...
  en: {
    ...
    step2Title: "AI creates your video", step2Desc: "Our AI composes a smooth presentation video with cinematic transitions and atmospheric music.",
  ...
  es: {
    ...
    step2Title: "La IA crea tu vídeo", step2Desc: "Nuestra IA compone un vídeo de presentación suave con transiciones cinematográficas y música ambiental.",
  ...
  de: {
    ...
    step2Title: "KI erstellt dein Video", step2Desc: "Unsere KI erstellt ein flüssiges Präsentationsvideo mit kinematischen Übergängen und atmosphärischer Musik.",
