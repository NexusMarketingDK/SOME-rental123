...
export const LANDING: Record<Locale, LandingT> = {
  da: {
    ...
    stat3Val: "< 5 min", stat3Label: "Video leveret",
    ...
    feat1Title: "Virtuel fremvisning via video", feat1Desc: "Upload billeder af din bolig — eller indsæt dit Novasol, Airbnb eller Booking.com link. AI skaber en professionel præsentationsvideo med musik og cinematiske kamerabevægelser på under 5 minutter.",
    ...
    aiSub: "Upload billeder af din bolig — eller indsæt et link fra Novasol, Airbnb eller Booking.com. SOME Video Post henter billederne og skaber en professionel præsentationsvideo med musik og cinematiske bevægelser på under 5 minutter.",
    ...
    walkthroughReadyIn: "✓ Klar om 5 min", walkthroughAiGenerates: "AI genererer",
    aiFeats: ["Novasol, Airbnb & Booking.com integration","Upload dine egne billeder","Cinematiske kamerabevægelser","Automatisk baggrundsmusik","Leveret på under 5 minutter","9:16 optimeret til Reels & TikTok"],
    aiOnetimeLabel: "Engangspris", aiOrderBtn: "Bestil video →",
    howTitle: "Klar til brug på få minutter", howSub: "Ingen teknisk viden påkrævet",
    easyTitle: "Så nemt er det", easySub: "Fra boliglink til færdigt opslag og video — på tre enkle trin. Kom i gang på få minutter.", easyCtaBtn: "Kom i gang nu",
    ...
    how2Title: "AI laver din præsentationsvideo", how2Desc: "SOME Video Post laver en professionel virtuel fremvisning med musik og cinematiske kamerabevægelser — klar på under 5 minutter.",
    ...
    plan2Items: ["Cinematisk AI-video af din bolig","Indsæt et link — AI bygger videoen","9:16 klar til Reels & TikTok","Se forhåndsvisning, betal når du er klar","Download & del direkte"],
    plan2StartBtn: "Kom i gang",
    plan3Name: "Pro", plan3OnetimeLabel: "Pr. måned",
    plan3Items: ["2 præsentationsvideoer inkluderet hver måned","20 SoMe-opslag (tekst + billede) hver måned","Meta-annoncering inkluderet","Del direkte på alle sociale medier","Automation & planlægning","Prioriteret support"],
    plan3OrderBtn: "Vælg Pro",
    planProCta: "Opret video", videoAddonLabel: "Ekstra præsentationsvideo", videoAddonPer: "/ stk.", videoAddonSub: "Ud over det din plan inkluderer",
    startFreeBtn: "Kom i gang",
    ...
    ctaBtn: "Kom i gang i dag", ctaNoCard: "Ingen binding · Afmeld når som helst",
    ...
    footerCreateAccount: "Opret konto", footerLogin: "Log ind",
    footerTryFree: "Kom i gang i dag", footerNoCard: "Ingen binding", footerStartBtn: "Start nu →",
  ...
  en: {
    ...
    stat3Val: "< 5 min", stat3Label: "Video delivered",
    ...
    feat1Title: "Virtual showing via video", feat1Desc: "Upload photos of your property — or paste your Novasol, Airbnb or Booking.com link. AI creates a professional presentation video with music and cinematic camera movements in under 5 minutes.",
    ...
    aiSub: "Upload photos of your property — or paste a link from Novasol, Airbnb or Booking.com. SOME Video Post fetches the images and creates a professional presentation video with music and cinematic movements in under 5 minutes.",
    ...
    walkthroughReadyIn: "✓ Ready in 5 min", walkthroughAiGenerates: "AI generates",
    aiFeats: ["Novasol, Airbnb & Booking.com integration","Upload your own photos","Cinematic camera transitions","Automatic background music","Delivered in under 5 minutes","9:16 optimised for Reels & TikTok"],
    aiOnetimeLabel: "One-time price", aiOrderBtn: "Order video →",
    howTitle: "Up and running in minutes", howSub: "No technical knowledge required",
    easyTitle: "It's this easy", easySub: "From property link to finished post and video — in three simple steps. Get started in minutes.", easyCtaBtn: "Get started now",
    ...
    how2Title: "AI creates your presentation video", how2Desc: "SOME Video Post creates a professional virtual showing with music and cinematic camera movements — ready in under 5 minutes.",
    ...
    plan2Items: ["Cinematic AI video of your property","Paste a link — AI builds the video","9:16 ready for Reels & TikTok","Preview it, pay when you're ready","Download & share directly"],
    plan2StartBtn: "Get started",
    plan3Name: "Pro", plan3OnetimeLabel: "Per month",
    plan3Items: ["2 presentation videos included every month","20 social posts (text + image) every month","Meta advertising included","Share directly to all social media","Automation & scheduling","Priority support"],
    plan3OrderBtn: "Choose Pro",
    planProCta: "Create video", videoAddonLabel: "Extra presentation video", videoAddonPer: "/ each", videoAddonSub: "Beyond what your plan includes",
    ...
    ctaBtn: "Get started today", ctaNoCard: "No commitment · Cancel anytime",
    ...
    footerCreateAccount: "Create account", footerLogin: "Log in",
    footerTryFree: "Get started today", footerNoCard: "No commitment", footerStartBtn: "Start now →",
  ...
  es: {
    ...
    stat3Val: "< 5 min", stat3Label: "Vídeo entregado",
    ...
    feat1Title: "Visita virtual en vídeo", feat1Desc: "Sube fotos de tu propiedad — o pega tu enlace de Novasol, Airbnb o Booking.com. La IA crea un vídeo de presentación profesional con música y movimientos de cámara cinematográficos en menos de 5 minutos.",
    ...
    aiSub: "Sube fotos de tu propiedad — o pega un enlace de Novasol, Airbnb o Booking.com. SOME Video Post descarga las imágenes y crea un vídeo de presentación profesional con música y movimientos cinematográficos en menos de 5 minutos.",
    ...
    walkthroughReadyIn: "✓ Listo en 5 min", walkthroughAiGenerates: "IA genera",
    aiFeats: ["Integración con Novasol, Airbnb & Booking.com","Sube tus propias fotos","Transiciones de cámara cinematográficas","Música de fondo automática","Entregado en menos de 5 minutos","9:16 optimizado para Reels & TikTok"],
    aiOnetimeLabel: "Precio único", aiOrderBtn: "Pedir vídeo →",
    howTitle: "Listo en pocos minutos", howSub: "Sin conocimientos técnicos necesarios",
    easyTitle: "Así de fácil es", easySub: "Del enlace de tu propiedad a la publicación y el vídeo terminados — en tres sencillos pasos. Empieza en minutos.", easyCtaBtn: "Empieza ahora",
    ...
    how2Title: "La IA crea tu vídeo de presentación", how2Desc: "SOME Video Post crea una visita virtual profesional con música y movimientos de cámara cinematográficos — lista en menos de 5 minutos.",
    ...
    plan2Items: ["Vídeo IA cinematográfico de tu propiedad","Pega un enlace — la IA crea el vídeo","9:16 listo para Reels y TikTok","Míralo en vista previa y paga cuando quieras","Descarga y comparte directamente"],
    plan2StartBtn: "Comenzar",
    plan3Name: "Pro", plan3OnetimeLabel: "Al mes",
    plan3Items: ["2 vídeos de presentación incluidos cada mes","20 publicaciones sociales (texto + imagen) al mes","Publicidad en Meta incluida","Comparte directamente en todas las redes","Automatización y programación","Soporte prioritario"],
    plan3OrderBtn: "Elegir Pro",
    planProCta: "Crear vídeo", videoAddonLabel: "Vídeo de presentación extra", videoAddonPer: "/ ud.", videoAddonSub: "Además de lo que incluye tu plan",
    startFreeBtn: "Comenzar",
    ...
    ctaBtn: "Empieza hoy", ctaNoCard: "Sin compromiso · Cancela cuando quieras",
    ...
    footerCreateAccount: "Crear cuenta", footerLogin: "Iniciar sesión",
    footerTryFree: "Empieza hoy", footerNoCard: "Sin compromiso", footerStartBtn: "Empezar ahora →",
  ...
  de: {
    ...
    stat3Val: "< 5 min", stat3Label: "Video geliefert",
    ...
    feat1Title: "Virtuelle Besichtigung per Video", feat1Desc: "Fotos hochladen — oder deinen Novasol, Airbnb oder Booking.com Link einfügen. KI erstellt ein professionelles Präsentationsvideo mit Musik und kinematischen Kamerabewegungen in unter 5 Minuten.",
    ...
    aiSub: "Fotos hochladen — oder einen Link von Novasol, Airbnb oder Booking.com einfügen. SOME Video Post lädt die Bilder herunter und erstellt ein professionelles Präsentationsvideo mit Musik und kinematischen Bewegungen in unter 5 Minuten.",
    ...
    walkthroughReadyIn: "✓ Fertig in 5 Min", walkthroughAiGenerates: "KI generiert",
    aiFeats: ["Novasol, Airbnb & Booking.com Integration","Eigene Fotos hochladen","Kinematische Kameraübergänge","Automatische Hintergrundmusik","In unter 5 Minuten geliefert","9:16 für Reels & TikTok optimiert"],
    aiOnetimeLabel: "Einmalpreis", aiOrderBtn: "Video bestellen →",
    howTitle: "In wenigen Minuten einsatzbereit", howSub: "Keine technischen Kenntnisse erforderlich",
    easyTitle: "So einfach ist das", easySub: "Vom Immobilienlink zum fertigen Beitrag und Video — in drei einfachen Schritten. Leg in wenigen Minuten los.", easyCtaBtn: "Jetzt starten",
    ...
    how2Title: "KI erstellt dein Präsentationsvideo", how2Desc: "SOME Video Post erstellt eine professionelle virtuelle Besichtigung mit Musik und kinematischen Kamerabewegungen — fertig in unter 5 Minuten.",
    ...
    plan2Items: ["Kinematisches KI-Video deiner Immobilie","Link einfügen — KI erstellt das Video","9:16 bereit für Reels & TikTok","Vorschau ansehen, zahlen wenn du bereit bist","Direkt herunterladen & teilen"],
    plan2StartBtn: "Loslegen",
    plan3Name: "Pro", plan3OnetimeLabel: "Pro Monat",
    plan3Items: ["2 Präsentationsvideos jeden Monat inklusive","20 Social-Media-Beiträge (Text + Bild) pro Monat","Meta-Werbung inklusive","Direkt auf allen sozialen Medien teilen","Automatisierung & Planung","Priorisierter Support"],
    plan3OrderBtn: "Pro wählen",
    planProCta: "Video erstellen", videoAddonLabel: "Zusätzliches Präsentationsvideo", videoAddonPer: "/ Stk.", videoAddonSub: "Zusätzlich zu den in deinem Plan enthaltenen",
    startFreeBtn: "Loslegen",
    ...
    ctaBtn: "Jetzt starten", ctaNoCard: "Keine Bindung · Jederzeit kündigen",
    ...
    footerCreateAccount: "Konto erstellen", footerLogin: "Anmelden",
    footerTryFree: "Jetzt loslegen", footerNoCard: "Keine Bindung", footerStartBtn: "Jetzt starten →",
