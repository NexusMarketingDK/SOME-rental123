...
export const LANDING: Record<Locale, LandingT> = {
  da: {
    ...
    plan1Name: "Starter",
    plan1Items: ["1 præsentationsvideo pr. måned inkluderet","50 gratis AI-genererede opslag — del med dine foretrukne billeder","Del opslag direkte på sociale medier","Download i alle formater","Op til 5 boliger"],
    plan2Name: "Pro", plan2PayLabel: "Betal per brug",
    plan2Items: ["2 præsentationsvideoer pr. måned inkluderet","Alt i Starter","100 AI-genererede opslag pr. måned","Del direkte på alle kanaler","Planlægning & analytics","Flere brands / projekter"],
    plan2StartBtn: "Kom i gang",
    plan3Name: "Business", plan3OnetimeLabel: "Engangspris pr. video",
    plan3Items: ["6 præsentationsvideoer pr. måned inkluderet","Alt inkluderet","Ubegrænsede AI-genererede opslag","Meta-integration for annoncering","Prioriteret support","Team & flere brugere"],
  ...
  en: {
    ...
    plan1Name: "Starter",
    plan1Items: ["1 presentation video per month included","50 free AI-generated posts — share with your own photos","Share posts directly to social media","Download in every format","Up to 5 properties"],
    plan2Name: "Pro", plan2PayLabel: "Pay-as-you-go",
    plan2Items: ["2 presentation videos per month included","Everything in Starter","100 AI-generated posts per month","Publish directly to all channels","Scheduling & analytics","Multiple brands / projects"],
    plan2StartBtn: "Get started",
    plan3Name: "Business", plan3OnetimeLabel: "One-time price per video",
    plan3Items: ["6 presentation videos per month included","Everything included","Unlimited AI-generated posts","Meta integration for advertising","Priority support","Team & multiple users"],
  ...
  es: {
    ...
    plan1Name: "Starter",
    plan1Items: ["1 vídeo de presentación al mes incluido","50 publicaciones generadas por IA gratis — comparte con tus propias fotos","Comparte publicaciones directamente en redes sociales","Descarga en todos los formatos","Hasta 5 propiedades"],
    plan2Name: "Pro", plan2PayLabel: "Pago por uso",
    plan2Items: ["2 vídeos de presentación al mes incluidos","Todo lo de Starter","100 publicaciones generadas por IA al mes","Publica directamente en todos los canales","Programación y analíticas","Varias marcas / proyectos"],
    plan2StartBtn: "Comenzar",
    plan3Name: "Business", plan3OnetimeLabel: "Precio único por vídeo",
    plan3Items: ["6 vídeos de presentación al mes incluidos","Todo incluido","Publicaciones generadas por IA ilimitadas","Integración con Meta para publicidad","Soporte prioritario","Equipo y varios usuarios"],
  ...
  de: {
    ...
    plan1Name: "Starter",
    plan1Items: ["1 Präsentationsvideo pro Monat inklusive","50 kostenlose KI-generierte Beiträge — mit eigenen Fotos teilen","Beiträge direkt in sozialen Medien teilen","Download in allen Formaten","Bis zu 5 Immobilien"],
    plan2Name: "Pro", plan2PayLabel: "Pay-as-you-go",
    plan2Items: ["2 Präsentationsvideos pro Monat inklusive","Alles aus Starter","100 KI-generierte Beiträge pro Monat","Direkt auf allen Kanälen veröffentlichen","Planung & Analytics","Mehrere Marken / Projekte"],
    plan2StartBtn: "Loslegen",
    plan3Name: "Business", plan3OnetimeLabel: "Einmalpreis pro Video",
    plan3Items: ["6 Präsentationsvideos pro Monat inklusive","Alles inklusive","Unbegrenzte KI-generierte Beiträge","Meta-Integration für Werbung","Priorisierter Support","Team & mehrere Nutzer"],
