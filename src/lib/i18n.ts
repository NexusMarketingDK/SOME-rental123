...
export const LANDING: Record<Locale, LandingT> = {
  da: {
    ...
    plan3Items: ["2 præsentationsvideoer inkluderet hver måned","20 SoMe-opslag (tekst + billede) hver måned","Del direkte på alle sociale medier","Automation & planlægning","Prioriteret support"],
  ...
  en: {
    ...
    plan3Items: ["2 presentation videos included every month","20 social posts (text + image) every month","Share directly to all social media","Automation & scheduling","Priority support"],
  ...
  es: {
    ...
    plan3Items: ["2 vídeos de presentación incluidos cada mes","20 publicaciones sociales (texto + imagen) al mes","Comparte directamente en todas las redes","Automatización y programación","Soporte prioritario"],
  ...
  de: {
    ...
    plan3Items: ["2 Präsentationsvideos jeden Monat inklusive","20 Social-Media-Beiträge (Text + Bild) pro Monat","Direkt auf allen sozialen Medien teilen","Automatisierung & Planung","Priorisierter Support"],
