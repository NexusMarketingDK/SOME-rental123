...
export default async function BillingPage() {
  const [subscription, credits] = await Promise.all([getSubscription(), getCredits()]);
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div>
                ...
                {isActive && (
                  <p className="mt-1 text-sm text-slate-500">
                    299 kr/md · {subscription?.cancel_at_period_end ? "Udløber" : "Fornyes"} {subscription?.current_period_end ? new Date(subscription.current_period_end).toLocaleDateString("da-DK") : ""}
                  </p>
                )}
              </div>
            ...
            {!isActive && (
              <div className="mt-6 rounded-xl border-2 border-[#1B3F7A] bg-blue-50/50 p-5">
                <p className="font-semibold text-[#1B3F7A]">Social Medie Plan — 299 kr/md</p>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">5 kr pr. AI-genereret opslag</p>
              </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <div key={pack.credits} className="rounded-lg border border-slate-200 p-3 text-center">
                  ...
                  <p className="text-sm text-slate-500">{pack.price} kr</p>
                  <div className="mt-2">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="ml-auto">
                <p className="text-xl font-bold text-slate-900">499 kr</p>
              </div>
            </div>
