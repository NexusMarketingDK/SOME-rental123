    ...
    <div className="flex min-h-screen flex-col bg-white text-slate-900">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3.5">
          ...
          <nav className="hidden items-center gap-6 text-sm font-medium text-slate-600 md:flex">
            <a href="#" className="hover:text-[#1B3F7A] transition-colors">Home</a>
            <a href="#features" className="hover:text-[#1B3F7A] transition-colors">Features</a>
            <a href="#ai" className="hover:text-[#1B3F7A] transition-colors">Video</a>
            <a href="#pricing" className="hover:text-[#1B3F7A] transition-colors">Pricing</a>
          </nav>
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-sm font-medium text-slate-600 hover:text-[#1B3F7A] transition-colors">Log in</Link>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <h1 className="text-4xl font-bold leading-tight text-white md:text-5xl lg:text-[3.25rem]">
                Rent out your<br />private home<br />
                <span style={{ background: "linear-gradient(90deg, #FFB36B, #FF6B4A)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>smarter</span>
              </h1>
              <p className="mt-5 max-w-lg text-base leading-relaxed text-blue-100">
                Vakanza helps private landlords market their vacation property — automatically. AI creates presentation videos from your photos, posts to social media and syncs your booking calendar.
              </p>
              ...
              <p className="mt-3 text-xs text-blue-300">No credit card required · Free to start</p>
              <div className="mt-8 flex flex-wrap gap-6 border-t border-white/10 pt-6">
                {[
                  { icon: Users, val: "500+", label: "Active hosts" },
                  { icon: TrendingUp, val: "3×", label: "More engagement" },
      ...
      <div className="border-y border-slate-100 bg-slate-50 py-4">
        <div className="mx-auto max-w-5xl px-6">
          <p className="mb-3 text-center text-xs font-semibold uppercase tracking-widest text-slate-400">Works with</p>
      ...
      <section id="features" className="py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-14 text-center">
            <h2 className="text-3xl font-bold text-[#1B3F7A] md:text-4xl">Everything you need — in one place</h2>
            <p className="mx-auto mt-3 max-w-xl text-slate-500">From Airbnb to TikTok. Vakanza brings it all together so you can focus on your guests.</p>
          </div>
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            <FeatureCard icon={Video} title="Virtual showing via video" desc="Upload photos of your property — or paste your Novasol, Airbnb or Booking.com link. AI creates a professional presentation video with music and cinematic camera movements in under 15 minutes." accent="bg-orange-50 text-orange-600" />
            <FeatureCard icon={Share2} title="Automatic social media posting" desc="One click sends your content to Facebook, Instagram, TikTok and LinkedIn. Vakanza schedules and posts automatically at your chosen times." accent="bg-blue-50 text-blue-600" />
            <FeatureCard icon={CalendarDays} title="Sync your booking calendar" desc="Import your existing calendar from Airbnb, Booking.com, Novasol or Google Calendar. All bookings in one place — always up to date." accent="bg-emerald-50 text-emerald-600" />
            <FeatureCard icon={Sparkles} title="AI writes your posts" desc="Let AI generate professional, engaging posts based on your property and season. Choose tone: family-friendly, luxury or last-minute offer." accent="bg-purple-50 text-purple-600" />
            <FeatureCard icon={Home} title="Private home or holiday house" desc="Vakanza is built for private landlords — summer house, apartment, villa or studio. No agency fees, no commitments." accent="bg-pink-50 text-pink-600" />
            <FeatureCard icon={Zap} title="Fully automatic autopilot" desc="Set Vakanza on autopilot and let AI handle all marketing. You focus on your guests — Vakanza handles the rest." accent="bg-yellow-50 text-yellow-600" />
          </div>
        </div>
      </section>
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg text-slate-400">
              Upload photos of your property — or paste a link from Novasol, Airbnb or Booking.com. Vakanza fetches the images and creates a professional presentation video with music and cinematic movements in under 15 minutes.
            </p>
          </div>
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
                  ...
                  <div className="relative aspect-[9/16] overflow-hidden" style={{ background: "linear-gradient(160deg, #1a2540 0%, #0d1520 100%)" }}>
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-black/30">
                      ...
                      <div className="mt-2 px-4 text-center">
                        <p className="text-[10px] font-semibold text-white/90">Seaside cottage, Skagen</p>
                        <p className="text-[9px] text-white/60">AI-generated presentation video</p>
                      </div>
                    </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-4">
                {[
                  { n: "01", title: "Paste a link or upload photos", desc: "We automatically fetch photos and property info from Novasol, Airbnb, Booking.com — or upload your own images directly." },
                  { n: "02", title: "AI creates your video", desc: "Higgsfield AI composes a smooth presentation video with cinematic transitions and atmospheric music." },
                  { n: "03", title: "Share on all platforms", desc: "Download the video and share it directly to Instagram Reels, TikTok and Facebook — all from one app." },
                ].map((step) => (
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  { value: "15 min", label: "generation time" },
              ...
              <div className="flex items-center justify-between rounded-2xl border border-orange-500/20 bg-orange-500/10 p-5">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wider text-orange-400">One-time price</p>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-3">
            {[
              ...
              "9:16 optimised for Reels & TikTok",
            ].map((f) => (
      ...
      <section className="py-24">
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-14 text-center">
            <h2 className="text-3xl font-bold text-[#1B3F7A] md:text-4xl">Up and running in 3 minutes</h2>
            <p className="mt-3 text-slate-500">No technical knowledge required</p>
          </div>
          <div className="relative grid gap-10 md:grid-cols-3">
            ...
            {[
              { n: "1", icon: Home, title: "Add your property", desc: "Upload photos or paste your Novasol, Airbnb or Booking.com link. Sync your existing booking calendar automatically." },
              { n: "2", icon: Video, title: "AI creates your presentation video", desc: "Vakanza creates a professional virtual showing with music and cinematic camera movements — ready in under 15 minutes." },
              { n: "3", icon: Zap, title: "Share automatically on social media", desc: "Vakanza posts your video and content to Facebook, Instagram, TikTok and LinkedIn — automatically and at the right time." },
            ].map((s) => (
      ...
      <section className="bg-slate-50 py-24">
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold text-[#1B3F7A]">What hosts say</h2>
            <p className="mt-3 text-slate-500">Used by hundreds of hosts across Denmark</p>
          </div>
          <div className="grid gap-5 md:grid-cols-3">
            <Testimonial name="Mette K." role="Airbnb host, Skagen" quote="I save at least 5 hours a week. Vakanza posts automatically while I focus on my guests. The videos are impressively professional!" />
            <Testimonial name="Thomas B." role="3 summer houses, Bornholm" quote="The AI videos have increased my bookings by 40%. It literally took 2 minutes to order — the video was ready before lunch." />
            <Testimonial name="Louise M." role="Holiday apartment, Copenhagen" quote="Finally I can reach all platforms without spending hours on it. AI-generated posts are better than what I'd write myself!" />
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="py-24">
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-14 text-center">
            <h2 className="text-3xl font-bold text-[#1B3F7A] md:text-4xl">Simple, transparent pricing</h2>
            <p className="mt-3 text-slate-500">No hidden fees · No commitment</p>
          </div>
          <div className="grid gap-6 md:grid-cols-3">
            <div className="relative rounded-2xl border-2 border-[#1B3F7A] bg-white p-8 shadow-xl md:col-span-1">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                <span className="rounded-full px-4 py-1 text-xs font-bold text-white" style={{ background: "linear-gradient(135deg, #FFB36B, #FF6B4A)" }}>Most popular</span>
              </div>
              <div className="mb-2 inline-flex items-center gap-2 rounded-lg bg-blue-50 px-2.5 py-1 text-xs font-semibold text-blue-700">
                <Share2 size={12} /> Social Media Plan
              </div>
              ...
              <ul className="my-7 flex flex-col gap-2.5">
                <Check>4 social media platforms</Check>
                <Check>Unlimited posts</Check>
                <Check>Automatic posting with custom schedule</Check>
                <Check>Calendar sync (Airbnb & Booking.com)</Check>
                <Check>Up to 5 properties</Check>
                <Check>AI posts — <strong>€0.67/post</strong></Check>
                <Check>AI images — <strong>€0.67/image</strong></Check>
              </ul>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8">
              <div className="mb-2 inline-flex items-center gap-2 rounded-lg bg-pink-50 px-2.5 py-1 text-xs font-semibold text-pink-600">
                <ImageIcon size={12} /> AI images & posts
              </div>
              <div className="mt-4 flex items-baseline gap-1">
              ...
              <ul className="my-7 flex flex-col gap-2.5">
                <Check>AI-generated professional posts</Check>
                <Check>AI-generated marketing images</Check>
                <Check>Choose tone and style</Check>
                <Check>Optimised for all platforms</Check>
                <Check>No subscription required</Check>
                <Check>Buy credits as needed</Check>
              </ul>
            ...
            <div className="rounded-2xl border border-orange-200 bg-orange-50/50 p-8">
              ...
              <p className="text-xs text-slate-400">One-time price per video</p>
              <ul className="my-7 flex flex-col gap-2.5">
                <Check>Fetches photos from Airbnb & Booking.com</Check>
                <Check>Or upload your own photos</Check>
                <Check>Professional video with music</Check>
                <Check>9:16 format for Reels & TikTok</Check>
                <Check>Delivered within 15 minutes</Check>
                <Check>Download directly in the app</Check>
              </ul>
      ...
      <section className="py-20 text-white" style={{ background: "linear-gradient(135deg, #0d1f3c 0%, #1B3F7A 100%)" }}>
        <div className="mx-auto max-w-3xl px-6 text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-medium">
            <Sparkles size={11} className="text-yellow-300" /> Save time from day 1
          </div>
          <h2 className="text-3xl font-bold md:text-4xl">Ready to market your<br />property on autopilot?</h2>
          <p className="mx-auto mt-4 max-w-lg text-blue-100">
            Join hundreds of hosts already using Vakanza to reach more guests — professionally and automatically.
          </p>
          ...
          <p className="mt-3 text-sm text-blue-300">No credit card · Cancel anytime</p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="grid gap-12 md:grid-cols-4">
            <div className="md:col-span-1">
              ...
              <p className="mt-4 text-sm leading-relaxed text-slate-400">AI-powered marketing for vacation rental hosts. Save time and reach more guests automatically.</p>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 text-sm text-slate-400">
                ...
                <li><Link href="/signup" className="transition-colors hover:text-white">Create free account</Link></li>
                <li><Link href="/login" className="transition-colors hover:text-white">Log in</Link></li>
              </ul>
            </div>
            <div>
              <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-slate-500">Integrations</p>
              <ul className="flex flex-col gap-3 text-sm text-slate-400">
                <li><span className="cursor-default">Airbnb</span></li>
                <li><span className="cursor-default">Booking.com</span></li>
                <li><span className="cursor-default">Facebook & Instagram</span></li>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 text-sm text-slate-400">
                ...
                <li><Link href="/signup" className="transition-colors hover:text-white">Get started</Link></li>
              </ul>
              <div className="mt-6 rounded-xl border border-orange-500/20 bg-orange-500/10 p-4">
                <p className="text-xs font-semibold text-orange-400">Try free today</p>
          ...
          <div className="mt-12 flex flex-col items-center gap-4 border-t border-white/5 pt-8 md:flex-row md:justify-between">
            <p className="text-xs text-slate-600">© 2026 Vakanza. All rights reserved.</p>
