...
import { Calendar, ChevronDown, ChevronUp, Pencil, X } from "lucide-react";
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-slate-100 bg-slate-50">
              ...
              <button
                type="button"
                onClick={() => setExpanded(false)}
                className="rounded-xl px-5 py-2 text-sm font-medium text-slate-600 hover:bg-slate-200 transition"
              >
                Luk
              </button>
            </div>
